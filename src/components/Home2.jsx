...
export default function Home2(props) {
  ...
  useEffect(
    ()=>{let idInterval = setInterval(()=>{next()},5000)
     setId(idInterval)
     return clearInterval(id)},[estilazo1,estilazo2,estilazo3])
let next = ()=>{
  ...
  } else if(estilazo1=="hide"&&estilazo2=="show"&&estilazo3=="hide"){
    setEstilazo1(estilazo1 = "hide")
    setEstilazo2(estilazo2="hide")
    setEstilazo3(estilazo3="show")
    } else if(estilazo1=="hide"&&estilazo2=="hide"&&estilazo3=="show"){
  ...
  return (
    <div className='Home2'>
        <Carrousel estilo1={estilazo1}  estilo2={estilazo2} estilo3={estilazo3} change={next} change2={prev}>
            <Footer /></Carrousel>
