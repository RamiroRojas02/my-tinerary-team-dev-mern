  ...
  const clickHandler = (e) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        dispatch(updateReactions(values)).then((res) => reload());
      }
    });
  };
        ...
        {reactionsItinerary.map((e) =>
          e.showId ? (
            <div className="myCard">
              ...
              <button
                className="btn-ReactionDelete"
                onClick={(o) => clickHandlerShow(e)}
              >
                Delete reaction
              </button>
            </div>
